							...
							<div class="p-4 space-y-2 text-sm">
								...
								<div class="space-y-2">
									...
									<div class="flex items-center text-gray-500">
										...
										Buka <?= date("H:i", strtotime($row['buka']))?> - <?= date("H:i", strtotime($row['tutup']))?> WITA</div>
								</div>
	
								<div class="flex justify-between items-center flex-wrap gap-3 pt-4">
									<span class="text-lg text-gray-400 font-semibold"><?= 'Rp.' . number_format($row['harga'], 0, ',', '.') ?></span>
