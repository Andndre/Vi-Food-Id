...
$locations = [
  [
    "judul" => "Dashboard",
    "icon" => "bar-chart-2",
    "href" => "/vi-food-id/admin/penjual/dashboard",
    "highlight" => "dashboard"
  ],
  [
    "judul" => "Manajemen Pesanan",
    "icon" => "bar-chart-2",
    "href" => "/vi-food-id/admin/penjual/manajemen-pesanan",
    "highlight" => "manajemen-pesanan"
  ],
  [
    "judul" => "Manajemen Menu",
    "icon" => "database",
    "href" => "/vi-food-id/admin/penjual/manajemen-menu",
...
>
  <div class="flex flex-col items-center mt-8">
    <img
      id="sidebar-logo"
      src="/vi-food-id/assets/images/logo-white.svg"
      alt="logo"
